document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        ...
        { time: 0.5, text: "Pain is never permanent, but tonight it's killing me" },
        { time: 4, text: "I hope you get your ballroom floor" },
        { time: 8, text: "Your perfect house with rose red doors" },
        { time: 11.5, text: "I'm the last thing you'd remember" },
        { time: 14, text: "It's been a long, lonely December" },
        { time: 17.5, text: "I wish I'd known that less is more" },
        { time: 21, text: "But I was passed out on the floor" },
        { time: 24.8, text: "That's the last thing I remember" },
        { time: 27.9, text: "It's been a long, lonely December" },
